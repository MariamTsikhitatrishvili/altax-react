function Footer({ partners }) {
    return (
        <div className="bg-slate-500 py-6 md:px-52 px-6 w-full flex flex-col items-center text-white">
            <div className="flex items-center justify-between md:mb-24 mb-4" >
